...
public class MainActivity extends Activity {
    ...
    private void setupSettingsAndPrefs() {
        ...
        // Let the RadioGroup manage standard child unchecking naturally to prevent layout measure state recursive loops
        if (useReal) {
    ...
    private void saveDocumentFromEditor() {
        ...
        String contents = mEditFileContent.getText().toString(); // Fixed: extract content properly via getText() to prevent stringification crashes
    ...
    private View appendChatBubble(String speaker, String text, String attachment) {
        // Enforce robust layout bounds in parent Linear container passes
    ...
    private class FileAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                // Standard LayoutParams setup targeting standard android.widget.AbsListView.LayoutParams
                LinearLayout root = new LinearLayout(MainActivity.this);
                root.setLayoutParams(new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                ...
                btnAttach.setLayoutParams(new LinearLayout.LayoutParams(dpToPx(60), dpToPx(36)));
                ...
                LinearLayout.LayoutParams optParams = new LinearLayout.LayoutParams(dpToPx(40), dpToPx(36));
                optParams.setMargins(dpToPx(6), 0, 0, 0);
