...
public class MainActivity extends Activity {
    ...
    private void updateMetadata() {
        ...
        if (!sandboxView.isSwapped()) {
            if (txtInfoA != null) txtInfoA.setText("Left/Full (Slot A): asset_6a9f18319c82d.png | Filter: " + filterName + " | Rotation: " + rotationText);
            if (txtInfoB != null) txtInfoB.setText("Right/Overlay (Slot B): asset_6a9f1839db93c.png | Filter: " + filterName + " | Rotation: " + rotationText);
        } else {
            if (txtInfoA != null) txtInfoA.setText("Left/Full (Slot A): asset_6a9f1839db93c.png | Filter: " + filterName + " | Rotation: " + rotationText);
            if (txtInfoB != null) txtInfoB.setText("Right/Overlay (Slot B): asset_6a9f18319c82d.png | Filter: " + filterName + " | Rotation: " + rotationText);
        }
    }
}