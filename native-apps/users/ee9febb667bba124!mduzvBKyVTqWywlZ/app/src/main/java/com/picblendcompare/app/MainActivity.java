...
public class MainActivity extends Activity {
            ...
            btnSwap.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (sandboxView != null) {
                        ...
                        updateMetadata();
                        Toast.makeText(MainActivity.this, "Swapped Positions", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void updateMetadata() {
        ...
        String nameA = sandboxView.getAssetNameA();
        String nameB = sandboxView.getAssetNameB();

        if (!sandboxView.isSwapped()) {
            if (txtInfoA != null) txtInfoA.setText("Left/Full (Slot A): " + nameA + " | Filter: " + filterName + " | Rotation: " + rotationText);
            if (txtInfoB != null) txtInfoB.setText("Right/Overlay (Slot B): " + nameB + " | Filter: " + filterName + " | Rotation: " + rotationText);
        } else {
            if (txtInfoA != null) txtInfoA.setText("Left/Full (Slot A): " + nameB + " | Filter: " + filterName + " | Rotation: " + rotationText);
            if (txtInfoB != null) txtInfoB.setText("Right/Overlay (Slot B): " + nameA + " | Filter: " + filterName + " | Rotation: " + rotationText);
        }
    }
}