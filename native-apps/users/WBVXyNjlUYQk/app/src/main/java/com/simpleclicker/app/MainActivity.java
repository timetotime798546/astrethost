...
public class MainActivity extends Activity {
    ...
    private void renderMetrics() {
        ...
        // Commit state reliably whenever values shift
        commitLocalPreferences();

        textHighScore.setText("High Score: " + highScoreValue);
        textTotalClicks.setText("Total Session Clicks: " + totalClicksValue);

        // Render dynamic achievement content cleanly based on score milestones
        if (isNewHighScore) {
            ...
            textAchievement.setTextColor(0xFF2563EB); // modern deep blue
            ...
            textAchievement.setTextColor(0xFFF59E0B); // warm yellow accent
        } else {
            textAchievement.setText("Keep clicking to set custom peaks!");
