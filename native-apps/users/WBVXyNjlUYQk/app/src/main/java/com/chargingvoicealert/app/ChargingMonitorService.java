...
public class ChargingMonitorService extends Service {
    ...
    private Notification buildMonitorNotification() {
        ...
        // Using standard safe public system drawable to avoid resource crashes across device skins
    ...
    private void speakPercentIncrease(int currentPercent) {
        ...
        if (pEnabled && iEnabled) {
            speak("Battery ek percent badh gayi hai. Ab total battery " + currentPercent + " percent hai.");
        }
    }
