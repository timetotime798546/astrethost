...
/**
 * A dynamic canvas animation engine built securely on top of pure standard Android SDK drawing
 * components. Creates smooth, high-fidelity real-time feedback loops depending on current app state.
 */
public class AiAnimationView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (currentState) {
            case STATE_IDLE:
                // Soft breathing dynamic green dot in center
            ...
            case STATE_LISTENING:
                // Concentric expanding cyan sound ripples simulating active listening ears
            ...
            case STATE_THINKING:
                // Three yellow/amber dots rotating clockwise around the center point
                paint.setStyle(Paint.Style.FILL);
            ...
            case STATE_SPEAKING:
                // Sound waves of varying heights bouncing dynamically up and down
                paint.setStyle(Paint.Style.FILL);
        ...
        if (isAnimating) {
            postInvalidateDelayed(32); // Target 30 FPS for optimized battery conservation
        }
    }
}