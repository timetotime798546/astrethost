...
public class TaskActivity extends Activity {
    ...
    private class TaskAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(TaskActivity.this).inflate(R.layout.task_item, parent, false);
            }
            final TaskItem item = taskList.get(position);
            final CheckBox chk = (CheckBox) convertView.findViewById(R.id.taskCheckBox);
            final TextView title = (TextView) convertView.findViewById(R.id.taskTitle);
            final Button btnDelete = (Button) convertView.findViewById(R.id.btnDeleteSingleTask);

            title.setText(item.title);
            
            // Avoid listener triggers during programmatic state adjustments
