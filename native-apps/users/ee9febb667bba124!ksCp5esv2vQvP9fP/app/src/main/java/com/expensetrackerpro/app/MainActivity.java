...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) { 
        ...
        // Prepopulate database with mockup data on fresh install
        seedSampleData();

        initViews();
        setupListeners();
        
        // Default View initialized without loader overlay
        refreshDashboard();
    }
    ...
    private void setupListeners() {
        ...
        // Set Item Long Click in Dashboard ListView to allow entry removal with Sound and Loader simulation
    ...
    private void showAddTransactionDialog() {
        ...
        // Handle Date picker instantiation on click
        ...
        // Dynamic Category loader based on selected radio button style type
        ...
        spinnerCategory.setAdapter(expenseAdapter); // Default is Expense
        ...
        builder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                // Validation will be triggered inside custom click handler below to avoid instant dismissal on invalid inputs
            }
        });
        ...
        // Overwriting default dismiss behaviour of dialog for strict data form checks
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Trigger saving visual indicator overlay loader with auditive cue
    ...
    private void seedSampleData() {
        ...
        if (currentList.isEmpty()) {
            ...
            // Seeding dynamic timestamps mapping
