...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setup default screen visual representation
        switchView(true);
    }
    ...
    private void setupListeners() {
        ...
        // Set Item Long Click in Dashboard ListView to allow entry removal
    ...
    private void switchView(boolean isTracker) {
        if (isTracker) {
    ...
    private void showAddTransactionDialog() {
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String typeStr = (checkedId == R.id.radio_income) ? "INCOME" : "EXPENSE";
