...
public class MainActivity extends Activity {
    ...
    private void setupServiceButtons() {
        ...
        btnStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, VoiceAssistantService.class);
                stopService(intent);
                updateUiState("STOPPED", "Shutdown sequence initialized.");
            }
        });
    }
    ...
    private void setupLanguageSpinner() {
        ...
        spinnerLanguage.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                // Notify live foreground system if active
    ...
    private void refreshServiceStatus() {
        if (isServiceActive(VoiceAssistantService.class)) {
            updateUiState("WAKE_WORD_LISTENING", "Popeen Assistant running in background.");
        } else {
            updateUiState("STOPPED", null);
        }
    }
    ...
    private void updateUiState(String state, String log) {
        ...
        if (log != null) {
            ...
            if (existingLogs.startsWith("Waiting for activity...")) {
                existingLogs = "";
            }
            String formattedLogs = "[" + System.currentTimeMillis() % 100000 / 1000 + "s] " + log + "\n" + existingLogs;
