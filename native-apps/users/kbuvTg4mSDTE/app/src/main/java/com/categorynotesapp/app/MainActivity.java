...
public class MainActivity extends Activity {
    ...
    private MediaPlayer mediaPlayer; // Added MediaPlayer
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingProgressBar = (ProgressBar) findViewById(R.id.loadingProgressBar); // Initialize ProgressBar
    ...
    private void showAddEditNoteDialog(final Note existingNote) {
        ...
        builder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                saveNotes();
                playSoundEffect(R.raw.sound_effect); // Play sound on save
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                saveNotes();
                                playSoundEffect(R.raw.sound_effect); // Play sound on delete
