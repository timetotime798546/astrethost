...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize SQLite Default Subjects
        ...
        // Setup Filter Spinner Callback Trigger
    ...
    private void refreshSubjectsList() {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                final int id = cursor.getInt(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_SUBJECT_ID));
                final String name = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_SUBJECT_NAME));
    ...
    private void refreshTasksSubjectSpinners() {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                int id = cursor.getInt(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_SUBJECT_ID));
    ...
    private void refreshTasksList() {
        ...
        if (spinnerFilterSubject.getSelectedItemPosition() > 0) {
            selectedFilterSubjectId = filterSubjectIds.get(spinnerFilterSubject.getSelectedItemPosition() - 1);
        }

        Cursor cursor = dbHelper.getTasksBySubject(selectedFilterSubjectId);
        if (cursor != null) {
            while (cursor.moveToNext()) {
                final int id = cursor.getInt(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_TASK_ID));
                final int subId = cursor.getInt(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_TASK_SUBJECT_ID));
                final String title = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_TASK_TITLE));
                final String dueDate = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_TASK_DUE_DATE));
                final String priority = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_TASK_PRIORITY));
                final int completed = cursor.getInt(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_TASK_COMPLETED));
    ...
    private void refreshRemindersList() {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                final int id = cursor.getInt(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_REMINDER_ID));
                final String title = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_REMINDER_TITLE));
                final String time = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_REMINDER_TIME));
    ...
    private void refreshProgress() {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                int subId = cursor.getInt(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_SUBJECT_ID));
                String name = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseHelper.COL_SUBJECT_NAME));
