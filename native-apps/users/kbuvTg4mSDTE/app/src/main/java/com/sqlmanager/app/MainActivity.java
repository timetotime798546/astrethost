...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Open/Init default database on startup
    ...
    private List<String> listDatabases() {
        ...
        // FIX: Replaced getDatabasePath("") with getDatabasePath("temp_db") to prevent
        // StringIndexOutOfBoundsException on empty file query inside validation logic.
